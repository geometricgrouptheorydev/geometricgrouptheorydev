...
- **General Group Handling:** Implementation of a composable `Group` interface for algebraic operations.
- **Group Presentations:** Word problem solvers and Tietze transformations.
